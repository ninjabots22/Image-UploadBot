...
async def start(client, message):
    await message.reply_text(f"<b>Hey {message.from_user.first_name}, Welcome to this bot\n\nI can Upload Any Photos to Telegraph! Type /cmds to know the Available Commands</b>", True)
